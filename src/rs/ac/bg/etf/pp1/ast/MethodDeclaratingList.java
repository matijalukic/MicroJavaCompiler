...
public class MethodDeclaratingList extends MethodDeclarationList {

    private MethodDeclarationList MethodDeclarationList;
    private MethodDeclaration MethodDeclaration;

    public MethodDeclaratingList (MethodDeclarationList MethodDeclarationList, MethodDeclaration MethodDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclaratingList(\n");
